 ...
 * @author Afrass Ilias
 */
public class MyFtpResource {
	final static private String url = "http://localhost:8080/rest/tp2/ftp";
	...
	public MyFtpResource(FTPClient ftp) {
		this.ftp = ftp;
	}
