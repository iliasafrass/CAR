 ...
 *
 */
public class HomePageWithPortConfig {
	final static String head="<html><head></head><body>";
	final static String authLink="<p><a href=" + "http://localhost:8080/rest/tp2/ftp2/auth"+ ">Cliquez ici pour l'authentification</a> </p>";
